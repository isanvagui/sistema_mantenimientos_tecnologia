...
def index_otros_equipos_tecnologia():
    ...
    ubicacionEquiposModal = {p["id"]: p["ubicacion_original"] for p in ubicacionEquipos_data}
    # print(ubicacionEquipos)
    return render_template('main.indexOtrosEquiposTecnologia.html', tecnologia_equipos=data_otros_equipos_tecnologia, tipoEquipos=tipoEquipos, proveedores=proveedores, personas=personas, estadoEquipos=estadoEquipos, ubicacionEquipos=ubicacionEquipos, ubicacionEquiposModal=ubicacionEquiposModal)
